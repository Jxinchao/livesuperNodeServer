const CONF = {
  ...
  // 微信小程序 App ID
  appId: 'wxdad8388e59f89655',

  // 微信小程序 App Secret
  appSecret: '112a5b796dc0808256b17bda0b5207c0',
  ...
  live: {
     ...
     */
    pushSecretKey: 'e45be25ff263c3f117d58e2e807abb8b',

    /**
     *  云直播 API鉴权key: 和appID 主要用于common cgi请求。appid 用于表示您是哪个客户，APIKey参与了请求签名sign的生成。
     *  后台用他们来校验common cgi调用的合法性。
     */
    APIKey: 'e45be25ff263c3f117d58e2e807abb8b  ',
